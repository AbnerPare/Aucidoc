        ...
        <div class="container mt-5 ">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h1 class="h1">
                        Résumés des rapports de projet
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="mt-5 container-fluid" style="height: 100% ;">
            <div class="row justify-content-center">
                <div class="col-md-2 col-6 col-sm-4 mt-1 " id="maCarte"
                    ...
                    <a href="{{ URL::to('/ded') }}"
                        style="background-color: #979187; display: block; border-radius: 50%; text-decoration:none; ">
                    ...
                    <a href="{{ URL::to('/administrative') }}"
                        ...
                        <div style="border-radius: 50%;">
                            <div class="card-body d-flex flex-column align-items-center"
                                style="text-align: center; height: 100%;">
                                <img src="img/logo.png" alt="..." width="50%">
                                <h5 style="margin-top: 10px; margin-bottom: 20px; color: white;">Actions <br>
                                    administrative
                                </h5>
                            </div>
                        </div>
